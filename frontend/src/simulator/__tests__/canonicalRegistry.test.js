...
describe('canonicalRegistry — contract shape', () => {
  it('exposes all 50 declared types', () => {
    ...
    // A9-LATCH1 : 49 -> 50 (D_LATCH_74HC75 ajouté).
    expect(getAllCanonicalTypes()).toHaveLength(50);
  ...
  it('getAllCanonicalEntries returns all 50 entries', () => {
    expect(getAllCanonicalEntries()).toHaveLength(50);
  });
