...
describe('canonicalRegistry — contract shape', () => {
  it('exposes all 32 declared types', () => {
    ...
    // A7-C4-IR : 31 -> 32 (IR_RECEIVER ajouté).
  ...
  it('getAllCanonicalEntries returns all 32 entries', () => {
    expect(getAllCanonicalEntries()).toHaveLength(32);
  });
