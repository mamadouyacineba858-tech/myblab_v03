...
describe('canonicalRegistry — contract shape', () => {
  it('exposes all 36 declared types', () => {
    ...
    // (ZENER_DIODE ajouté).
    expect(getAllCanonicalTypes()).toHaveLength(36);
  ...
  it('getAllCanonicalEntries returns all 36 entries', () => {
    expect(getAllCanonicalEntries()).toHaveLength(36);
  });
