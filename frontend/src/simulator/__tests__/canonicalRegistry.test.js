...
describe('canonicalRegistry — contract shape', () => {
  it('exposes all 48 declared types', () => {
    ...
    // A9-NAND : 43 -> 44 (NAND_GATE ajouté). A9-NOR : 44 -> 45 (NOR_GATE ajouté).
    // A9-XOR : 45 -> 46 (XOR_GATE ajouté). A9-NOT : 46 -> 47 (NOT_GATE ajouté).
    // A9-JK1 : 47 -> 48 (JK_FLIP_FLOP_74HC73 ajouté).
    expect(getAllCanonicalTypes()).toHaveLength(48);
  ...
  it('getAllCanonicalEntries returns all 48 entries', () => {
    expect(getAllCanonicalEntries()).toHaveLength(48);
  });
