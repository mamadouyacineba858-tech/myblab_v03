...
describe('canonicalRegistry — contract shape', () => {
  it('exposes all 42 declared types', () => {
    ...
    expect(getAllCanonicalTypes()).toHaveLength(42);
  ...
  it('getAllCanonicalEntries returns all 42 entries', () => {
    expect(getAllCanonicalEntries()).toHaveLength(42);
  });
