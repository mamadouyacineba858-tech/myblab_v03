...
describe('canonicalRegistry — contract shape', () => {
  it('exposes all 49 declared types', () => {
    ...
    expect(getAllCanonicalTypes()).toHaveLength(49);
  ...
  it('getAllCanonicalEntries returns all 49 entries', () => {
    expect(getAllCanonicalEntries()).toHaveLength(49);
  });
