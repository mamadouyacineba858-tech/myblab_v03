...
describe('canonicalRegistry — contract shape', () => {
  it('exposes all 43 declared types', () => {
    ...
    expect(getAllCanonicalTypes()).toHaveLength(47);
  ...
  it('getAllCanonicalEntries returns all 47 entries', () => {
    expect(getAllCanonicalEntries()).toHaveLength(47);
  });
