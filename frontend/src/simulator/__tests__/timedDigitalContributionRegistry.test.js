...
describe("A7-C5-PREQ/A7-C5 — TD-01/TD-02/TD-03 : Registry de production", () => {
  it("TD-01 — HC_SR04 (A7-C5), JK_FLIP_FLOP_74HC73 (A9-JK1), D_FLIP_FLOP_74HC74 (A9-DFF1), D_LATCH_74HC75 (A9-LATCH1) et BINARY_COUNTER_74HC161 (A9-COUNTER1) sont les seuls types réels enregistrés à ce jour", () => {
    expect(getAllTimedDigitalContributionTypes()).toEqual(["HC_SR04", "JK_FLIP_FLOP_74HC73", "D_FLIP_FLOP_74HC74", "D_LATCH_74HC75", "BINARY_COUNTER_74HC161"])
  })
