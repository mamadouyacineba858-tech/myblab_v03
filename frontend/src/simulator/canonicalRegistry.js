const DECLARED_TYPES_PINS = {
  ...
  // A9-NOR: same 2-input/1-output electrical shape as AND_GATE/OR_GATE/NAND_GATE.
  NOR_GATE:[{id:'A',role:'input'},{id:'B',role:'input'},{id:'Q',role:'output'}],
  // A9-XOR: same 2-input/1-output electrical shape as AND_GATE/OR_GATE/NAND_GATE/NOR_GATE.
  XOR_GATE:[{id:'A',role:'input'},{id:'B',role:'input'},{id:'Q',role:'output'}],
  // A9-NOT: 1-input/1-output inverter, exactly two electrical pins (no B, no VCC/GND).
  NOT_GATE:[{id:'A',role:'input'},{id:'Q',role:'output'}],
  ...
  // A9-JK1 : 74HC73 DIP-14, double bascule J-K — 14 pins ELECTRIQUES, ordre = broches
  // physiques 1..14 (1CP 1R 1K VCC 2CP 2R 2J 2NQ 2Q 2K GND 1Q 1NQ 1J).
  JK_FLIP_FLOP_74HC73:[{id:'1CP',role:'input'},{id:'1R',role:'input'},{id:'1K',role:'input'},{id:'VCC',role:'power'},{id:'2CP',role:'input'},{id:'2R',role:'input'},{id:'2J',role:'input'},{id:'2NQ',role:'output'},{id:'2Q',role:'output'},{id:'2K',role:'input'},{id:'GND',role:'ground'},{id:'1Q',role:'output'},{id:'1NQ',role:'output'},{id:'1J',role:'input'}],
}

const DECLARED_TYPE_ORDER = ['LED','RESISTOR','ARDUINO','BUTTON','BUTTON_LATCHING','POWER','BATTERY_AA','COIN_CELL_CR2032','BATTERY_9V','CAPACITOR','BUZZER','POTENTIOMETER','LDR','THERMISTOR','DIODE','RGB_LED','NPN_TRANSISTOR','PNP_TRANSISTOR','NMOS','PMOS','VOLTAGE_REGULATOR','RELAY','SERVO','DC_MOTOR','POLARIZED_CAPACITOR','SLIDE_SWITCH','DIP_SWITCH','VIBRATION_MOTOR','LIGHT_BULB','HOBBY_GEARMOTOR','TMP36','FORCE_SENSOR','FLEX_SENSOR','SOIL_MOISTURE_SENSOR','PIR_MOTION_SENSOR','TILT_SENSOR','IR_RECEIVER','HC_SR04','INDUCTOR','ZENER_DIODE','H_BRIDGE','AND_GATE','OR_GATE','NAND_GATE','NOR_GATE','XOR_GATE','NOT_GATE','JK_FLIP_FLOP_74HC73']
...
const DECLARED_CAPABILITIES = {
  ...
  H_BRIDGE:['digital'],
  // A9-JK1 : sequentiel pur, sorties via le registre timed/stateful (aucune contribution DC).
