...
export function CircuitProvider({ children, canvasRef, orchestrators }) {
  ...
  const stableValue = useMemo(() => ({
    ...
    toggleComponentState: state.toggleComponentState,
    toggleComponentChannel: state.toggleComponentChannel,
    ...
    state.selectOnly, state.toggleLatchingButton, state.toggleComponentState, state.toggleComponentChannel, state.toggleSelection, state.isSelected,
