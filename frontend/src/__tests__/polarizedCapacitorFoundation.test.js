...
describe('FT-C-COMP-002 — non-régression', () => {
  ...
  it('POLARIZED_CAPACITOR est bien un AJOUT (28 types, A3-SW2 : DIP_SWITCH ajouté depuis, A6-OUT1 : VIBRATION_MOTOR ajouté depuis, A6-OUT2 : LIGHT_BULB ajouté depuis, A6-OUT3 : HOBBY_GEARMOTOR ajouté depuis, A7-C1 : TMP36 ajouté depuis, A7-C2 : FORCE_SENSOR + FLEX_SENSOR ajoutés depuis) sans retrait', () => {
    expect(getAllCanonicalTypes()).toHaveLength(28)
