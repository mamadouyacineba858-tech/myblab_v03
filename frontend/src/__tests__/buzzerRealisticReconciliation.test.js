...
describe('FT-C-COMP-004 — non-régression du modèle électrique et des autres composants', () => {
  ...
  it('T28 (catalogue) — toujours 28 types canoniques (A3-SW2 : DIP_SWITCH ajouté ; A6-OUT1 : VIBRATION_MOTOR ajouté ; A6-OUT2 : LIGHT_BULB ajouté ; A6-OUT3 : HOBBY_GEARMOTOR ajouté ; A7-C1 : TMP36 ajouté ; A7-C2 : FORCE_SENSOR + FLEX_SENSOR ajoutés), BUZZER inclus une seule fois', () => {
