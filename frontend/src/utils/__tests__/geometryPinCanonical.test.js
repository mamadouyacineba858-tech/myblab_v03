...
describe("MB-VIS-COMP-005 — getPinPosition() : fonction géométrique canonique", () => {
  ...
  it("TEST 10 — régression : RESISTOR/LED/CAPACITOR/BUTTON/BUTTON_LATCHING/POTENTIOMETER conservent leurs positions de pins existantes", () => {
    ...
    // visuellement différent, non reconduits) — centre de masse pondéré
    // par alpha sur chaque patte, canvas.getImageData sur
    // button.released.3x.png / button-latching.off.3x.png, cohérent 1x/3x
    // — voir componentDefinitions.js et Delivery Report.
    const expected = {
