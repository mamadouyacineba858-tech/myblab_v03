...
describe('FT-B-001-S4 — TEST S4-K/N : matrice API PhysicalContact du catalogue', () => {
  const CATALOGUE = [
    ...
    'BUZZER', 'POTENTIOMETER', 'LDR', 'THERMISTOR', 'DIODE', 'RGB_LED', 'NPN_TRANSISTOR', 'PNP_TRANSISTOR',
  ...
  it('le catalogue compte exactement 36 types', () => {
    ...
    expect(new Set(CATALOGUE).size).toBe(36)
  ...
  it('classification breadboardInsertable finale S5 : 28 enfichables / 8 non-directs', () => {
