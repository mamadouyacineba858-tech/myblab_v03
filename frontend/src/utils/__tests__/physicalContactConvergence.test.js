...
describe('FT-B-001-S4 — TEST S4-K/N : matrice API PhysicalContact du catalogue', () => {
  const CATALOGUE = [
    ...
    'PIR_MOTION_SENSOR', 'TILT_SENSOR', 'IR_RECEIVER', 'HC_SR04', 'INDUCTOR', 'ZENER_DIODE', 'H_BRIDGE', 'AND_GATE', 'OR_GATE', 'NAND_GATE', 'NOR_GATE', 'XOR_GATE', 'NOT_GATE', 'JK_FLIP_FLOP_74HC73', 'D_FLIP_FLOP_74HC74',
  ]

  it('le catalogue compte exactement 49 types', () => {
    ...
    // A9-DFF1 : 48 -> 49 (D_FLIP_FLOP_74HC74 ajouté).
    expect(new Set(CATALOGUE).size).toBe(49)
  ...
  it('classification breadboardInsertable finale S5 : 30 enfichables / 8 non-directs', () => {
    const INSERTABLE = ['RESISTOR', 'LED', 'DIODE', 'CAPACITOR', 'LDR', 'THERMISTOR',
      ...
      // A9-NAND : 3 PhysicalContacts A/B/Q, entraxe 24 = 2×BREADBOARD_PITCH
      // exact entre A/B et B/Q (cf. nandGateA9.test.js) -> breadboardInsertable:true.
      'NAND_GATE',
      // A9-NOR : 3 PhysicalContacts A/B/Q, entraxe 24 = 2×BREADBOARD_PITCH
      // exact entre A/B et B/Q (cf. norGateA9.test.js) -> breadboardInsertable:true.
      'NOR_GATE',
      // A9-XOR : 3 PhysicalContacts A/B/Q, entraxe 24 = 2×BREADBOARD_PITCH
      // exact entre A/B et B/Q (cf. xorGateA9.test.js) -> breadboardInsertable:true.
      'XOR_GATE',
      ...
      // -> breadboardInsertable:true.
      'JK_FLIP_FLOP_74HC73',
      // A9-DFF1 : 74HC74 DIP-14, 14 PhysicalContacts CSA LOCKED au pas 12, rangées
      // écartées de 48 = 4×BREADBOARD_PITCH (cf. DFlipFlop74HC74Part.raster.test.jsx)
      // -> breadboardInsertable:true.
      'D_FLIP_FLOP_74HC74']
