...
describe('A9-NOR-ASSET-FIX frozen raster asset (transparency lock, no applicative logic)', () => {
  ...
  it('A9-NOR (functional ticket) filled the real pixel-probe left unmeasured by this asset-fix ticket', () => {
    // A9-NOR-ASSET-FIX deliberately left pixelProbe as
    // 'NOT_MEASURED_IN_A9-NOR-ASSET-FIX_SCOPE' (no functional ticket
    // authorized yet). A9-NOR is that functional ticket: it measured A/B/Q
