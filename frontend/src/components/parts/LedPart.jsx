...
/** Realistic through-hole LED. Visual legs are vertical; electrical anchors remain horizontal. */
      ...
      >
        <defs>
          <linearGradient id="ledDome" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" stopColor={isOn ? '#ff9b9b' : '#c33a43'} />
            <stop offset="0.3" stopColor={isOn ? '#ff4b4b' : '#a51f29'} />
            <stop offset="0.65" stopColor={isOn ? '#dc171f' : '#80151d'} />
            <stop offset="1" stopColor={isOn ? '#850b12' : '#4c0a10'} />
          </linearGradient>
          <linearGradient id="ledFlange" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="#f4f5f6" />
            <stop offset="0.3" stopColor="#b8bdc1" />
            <stop offset="0.7" stopColor="#646a6e" />
            <stop offset="1" stopColor="#363a3d" />
          </linearGradient>
          <linearGradient id="ledMetal" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="#ffffff" />
            <stop offset="0.25" stopColor="#c6ccd0" />
            <stop offset="0.6" stopColor="#596168" />
            <stop offset="0.82" stopColor="#eef1f3" />
            <stop offset="1" stopColor="#777f85" />
          </linearGradient>
          ...
          <filter id="ledShadow" x="-30%" y="-30%" width="160%" height="160%">
        ...
        {/* Physical leads: deliberately vertical and clearly visible below the flange. */}
        <path d="M31 35 V68" stroke="url(#ledMetal)" strokeWidth="4" strokeLinecap="round" />
        <path d="M49 35 V68" stroke="url(#ledMetal)" strokeWidth="4" strokeLinecap="round" />
        <path d="M31 36 V68" stroke="#ffffff" strokeOpacity=".28" strokeWidth="1" />
        <path d="M49 36 V68" stroke="#ffffff" strokeOpacity=".28" strokeWidth="1" />
