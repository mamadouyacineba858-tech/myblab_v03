  ...
  return (
    <div className="part-resistor" aria-label="Résistance">
      <svg viewBox="0 0 84 28" width="84" height="28" role="img" aria-hidden="true">
        ...
        <line x1="0" y1="14" x2="18" y2="14" stroke="url(#resistorMetal)" strokeWidth="4.4" strokeLinecap="round" />
        <line x1="72" y1="14" x2="84" y2="14" stroke="url(#resistorMetal)" strokeWidth="4.4" strokeLinecap="round" />
        <line x1="1" y1="13.05" x2="17" y2="13.05" stroke="#fff" strokeOpacity=".34" strokeWidth="0.85" strokeLinecap="round" />
        <line x1="73" y1="13.05" x2="83" y2="13.05" stroke="#fff" strokeOpacity=".34" strokeWidth="0.85" strokeLinecap="round" />
