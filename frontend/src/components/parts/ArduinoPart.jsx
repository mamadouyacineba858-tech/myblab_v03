 ...
 * - la sérigraphie réelle du PCB doit devenir lisible par agrandissement ;
 ...
 *
 * La lecture de `simulationActive` est volontairement purement présentation :
 * le renderer observe le contexte stable s'il existe ; rendu standalone/test
 * sans Provider => ARRÊT. Aucun état runtime n'est persisté ici.
 */
...
// La première correction 1.30× a été refusée au Canvas Gate : les écritures
// restaient illisibles. La nouvelle cible reprend le zoom validé visuellement.
