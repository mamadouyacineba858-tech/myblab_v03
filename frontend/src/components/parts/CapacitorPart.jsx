 ...
 * marquage « 104 », deux pattes verticales parallèles. Aucune polarité n'est
 * affichée ni suggérée.
 *
 * Invariants :
 * - identité électrique historique pinA/pinB inchangée ;
 * - composant non polarisé : aucune borne + / - ;
 * - corps uniquement ici ; les pattes sont rendues par AssemblyLeadsLayer ;
