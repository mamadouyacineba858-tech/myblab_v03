...
export const SCALE_REFERENCE = Object.freeze([
  ...
  { type: 'SEVEN_SEGMENT_DISPLAY', box: [72, 114], physicalMm: [12.7, 19.05], ref: 'Kingbright SC56-11EWA 0.56in single digit, body 12.7 x 19.05 mm; CSA contacts normalized 12 px per 2.54 mm', impliedUnitsPerMm: 12 / 2.54 },
