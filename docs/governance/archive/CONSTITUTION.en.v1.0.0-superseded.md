# [ARCHIVÉ / SUPERSEDED] MYBlab Constitution (EN, v1.0.0)

**Statut :** ARCHIVÉ — remplacé par `docs/governance/MYBLAB-CONSTITUTION.md` (v1.3, 2026-08-25)
**Raison de l'archivage :** deux documents se réclamant du niveau 1 coexistaient dans le dépôt (ambiguïté relevée par `docs/roadmaps/amendments/2026-08-22-P2-0-reconciliation.md` §3). `MYBLAB-CONSTITUTION.md` était déjà la seule version citée comme autorité par le reste du dépôt (`CONVENTIONS.md`, `ARCHITECTURE.md`, `MYBLAB_VISION_2030.md`, `ADR-011`) ; le contenu substantiel du présent document qui n'avait pas d'équivalent y a été intégré (Articles 16 à 22, et ajouts aux Articles 4 et 7).
**Conservé conformément à :** `MYBLAB-CONSTITUTION.md`, Article 20 — Préservation des artefacts historiques.

**Ne pas traiter ce document comme une autorité en vigueur.** Pour la Constitution officielle, voir `docs/governance/MYBLAB-CONSTITUTION.md`.

---

Contenu original conservé tel quel ci-dessous, sans modification, à titre de trace historique.
